...
** 29 Jan 2024
	...
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal"
	 use "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\firm_level_entry_exit_seasonal.dta" 

	log using "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\seasonal_firm_level_entry_exit_analysis.smcl", replace 
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal"
...
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\CIT Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\CIT Survivors"
	preserve 
...
* nbreg unweighted
	...
	estimates clear 
	nbreg count_agri c.prop_affected_all##ib(2013).taxyear  gender_fill prop_age_cat_* i.mode_prov_num rainfall, cluster(taxrefno) exposure(L.firm_size_year) 
...
* nbreg weighted
	...
	nbreg count_agri c.prop_affected_all##ib(2013).taxyear  gender_fill prop_age_cat_* i.mode_prov_num rainfall  [pw=firm_size_year], cluster(taxrefno) exposure(L.firm_size_year) 
	estimates store reg8
summ prop_affected_all if taxyear==2013 & e(sample)==1
...
*nbreg unweighted
	estimates clear
	nbreg entry_agri c.prop_affected_all##ib(2013).taxyear  gender_fill prop_age_cat_* i.mode_prov_num rainfall, cluster(taxrefno) exposure(firm_size_year)
...
*nbreg weighted
	nbreg entry_agri c.prop_affected_all##ib(2013).taxyear  gender_fill  prop_age_cat_* i.mode_prov_num rainfall [pw=firm_size_year], cluster(taxrefno) exposure(firm_size_year)
		estimates store reg6
	summ prop_affected_all if taxyear==2013 & e(sample)==1
...
*nbreg unweighted
	estimates clear
	nbreg exit_agri_new c.prop_affected_all##ib(2013).taxyear gender_fill prop_age_cat_* i.mode_prov_num rainfall, cluster(taxrefno) exposure(L.firm_size_year)
		estimates store reg6
	summ prop_affected_all if taxyear==2013 & e(sample)==1
...
*nbreg weighted
	estimates clear
	nbreg exit_agri_new c.prop_affected_all##ib(2013).taxyear  gender_fill prop_age_cat_* i.mode_prov_num rainfall [pw=firm_size_year], cluster(taxrefno) exposure(L.firm_size_year)
		estimates store reg6
	summ prop_affected_all if taxyear==2013 & e(sample)==1
...
* 							Total employment									*
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\Non CIT Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\Non CIT Survivors"

	preserve 
	keep if merge_CIT==1 & survivor==1  
...
* 							Total employment									*
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\CIT NON Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\CIT NON Survivors"
...
* 							Total employment									*
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\NON CIT NON Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Seasonal\Non CIT NON Survivors"
...
* coef plot - full model with dynamic offset variable
	coefplot reg6, vertical keep(2012.taxyear#c.prop_affected_all 2013.taxyear#c.prop_affected_all 2014.taxyear#c.prop_affected_all 2015.taxyear#c.prop_affected_all 2016.taxyear#c.prop_affected_all 2017.taxyear#c.prop_affected_all)///
