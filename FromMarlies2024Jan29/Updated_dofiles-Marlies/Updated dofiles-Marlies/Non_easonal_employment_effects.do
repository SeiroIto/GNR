...
** 29 Jan 2024
	...
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal"
	use  "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\firm_level_entry_exit_non_seasonal.dta" 

	log using "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\non_seasonal_firm_level_entry_exit_analysis.smcl", replace 
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal"
...
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\CIT Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\CIT Survivors"
	preserve 
...
* nbreg unweighted
	...
	estimates clear 
	nbreg count_agri c.prop_affected_all##ib(2013).taxyear  gender_fill age_q* i.mode_prov_num rainfall, cluster(taxrefno) exposure(L.firm_size_year) 
...
* nbreg weighted
	...
	nbreg count_agri c.prop_affected_all##ib(2013).taxyear  gender_fill age_q* i.mode_prov_num rainfall  [pw=firm_size_year], cluster(taxrefno) exposure(L.firm_size_year) 
	estimates store reg8
summ prop_affected_all if taxyear==2013 & e(sample)==1
...
*nbreg unweighted
	estimates clear
	nbreg entry_agri c.prop_affected_all##ib(2013).taxyear  gender_fill age_q* i.mode_prov_num rainfall, cluster(taxrefno) exposure(firm_size_year)
...
*nbreg weighted
	nbreg entry_agri c.prop_affected_all##ib(2013).taxyear  gender_fill  age_q* i.mode_prov_num rainfall [pw=firm_size_year], cluster(taxrefno) exposure(firm_size_year)
		estimates store reg6
	summ prop_affected_all if taxyear==2013 & e(sample)==1
...
*nbreg unweighted
	estimates clear
	nbreg exit_agri_new c.prop_affected_all##ib(2013).taxyear gender_fill age_q* i.mode_prov_num rainfall, cluster(taxrefno) exposure(L.firm_size_year)
		estimates store reg6
	summ prop_affected_all if taxyear==2013 & e(sample)==1
...
*nbreg weighted
	estimates clear
	nbreg exit_agri_new c.prop_affected_all##ib(2013).taxyear  gender_fill age_q* i.mode_prov_num rainfall [pw=firm_size_year], cluster(taxrefno) exposure(L.firm_size_year)
		estimates store reg6
	summ prop_affected_all if taxyear==2013 & e(sample)==1
...
* 							Total employment									*
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\Non CIT Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\Non CIT Survivors"
...
* 							Total employment									*
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\CIT NON Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\CIT NON Survivors"
...
* 							Total employment									*
********************************************************************************
	cap mkdir "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\NON CIT NON Survivors"
	cd "Z:\Workbenches\epadmin\michael_kilumelume\2024 projects\minimum wage\datasets for Marlies\Analysis using Marlies code and Michael's samples\Non Seasonal\CIT NON Survivors"
